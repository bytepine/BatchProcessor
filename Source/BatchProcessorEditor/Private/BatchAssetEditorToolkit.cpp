...
void FBatchAssetEditorToolkit::FillToolbar(FToolBarBuilder& Builder)
{
    ...
    Builder.AddToolBarButton(
        ...
        FSlateIcon(BATCH_APP_STYLE_SET_NAME, "Icons.Play"));
    ...
    Builder.AddToolBarButton(
        ...
        FSlateIcon(BATCH_APP_STYLE_SET_NAME, "Icons.Visibility"));
    ...
    Builder.AddToolBarButton(
        ...
        FSlateIcon(BATCH_APP_STYLE_SET_NAME, "Icons.Stop"));
    ...
    Builder.AddToolBarButton(
        ...
        FSlateIcon(BATCH_APP_STYLE_SET_NAME, "Icons.Search"));
